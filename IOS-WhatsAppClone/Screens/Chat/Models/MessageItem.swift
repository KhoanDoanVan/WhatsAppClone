...
struct MessageItem: Identifiable {
    ...
    static let sentPlaceholder = MessageItem(id: UUID().uuidString, text: "Holy Shit", type: .text, ownerUid: "1", timeStamp: Date())
    static let receivedPlaceholder = MessageItem(id: UUID().uuidString, text: "Ok Shit", type: .text, ownerUid: "2", timeStamp: Date())
